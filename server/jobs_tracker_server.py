...
def auth():
    if request.method == 'GET':
        ...
        # return render_template('profile-page.html', name=id_info['name'])
    ...
    if request.method == 'POST':
        ...
        return jsonify(id_info)
        # return render_template('profile-page.html', name=id_info[
        # 'given_name'])


@app.route('/delete_everything', methods=['GET'])
...
def skills():
    ...
    if not skill_list:
        skill_list.append({'id': '',
                           'skill': 'Nothing in here'})
...
def update_skill():
    ...
    if request.method == 'POST':
        ...
        new_skill.update({'skill': content['skill']})
